    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <input
          ...
          className="w-full p-2 text-center text-sm font-semibold border-2 border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:border-black focus:ring-4 focus:ring-black/10 transition-all col-span-1"
        />
        <div className="relative col-span-2">
          <select
            value={passengerType.type}
            onChange={(e) => onChange({ type: e.target.value as 'student' | 'regular' })}
            className="w-full p-2 text-left text-sm font-semibold border-2 border-gray-200 rounded-lg bg-gray-50 appearance-none focus:outline-none focus:border-black focus:ring-4 focus:ring-black/10 transition-all"
          >
